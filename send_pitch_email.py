...
def send_pitch_email():
    ...
    html_body = """
    <html>
    <body style="font-family: Arial, sans-serif; max-width: 680px; margin: 0; color: #1a1a1a;">

      <!-- Header -->
      <div style="background: linear-gradient(135deg, #B71C1C, #FF5722);
                  padding: 0; border-radius: 12px 12px 0 0; text-align: center;">
      ...
      <!-- Live Data Banner -->
      <div style="background: #1a1a1a; padding: 0; text-align: center;">
      ...
      <div style="padding: 0; background: #ffffff;
        ...
        <hr style="border: none; border-top: 2px solid #FF5722; margin: 0;">
        ...
        <div style="background: #FFF3E0; border-left: 5px solid #FF5722;
                    padding: 0; border-radius: 0 8px 8px 0; margin: 0;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 25px;">
          <tr style="background: #f5f5f5;">
            <td style="padding: 0; font-weight: bold;">🛰️ NASA FIRMS Satellite</td>
            <td style="padding: 0; color: #2e7d32; font-weight: bold;">LIVE</td>
            <td style="padding: 0;">3,294 fire detections pulled today</td>
          </tr>
          <tr>
            <td style="padding: 0; font-weight: bold;">🌫️ EPA AirNow PM2.5</td>
            <td style="padding: 0; color: #2e7d32; font-weight: bold;">LIVE</td>
            <td style="padding: 0;">Traverse City AQI 133 — smoke confirmed</td>
          </tr>
          <tr style="background: #f5f5f5;">
            <td style="padding: 0; font-weight: bold;">📧 Email Alert Pipeline</td>
            <td style="padding: 0; color: #2e7d32; font-weight: bold;">LIVE</td>
            <td style="padding: 0;">You're reading proof of this right now</td>
          </tr>
          <tr>
            <td style="padding: 0; font-weight: bold;">📱 SMS to Firefighters</td>
            <td style="padding: 0; color: #FF9800; font-weight: bold;">READY</td>
            <td style="padding: 0;">Twilio integrated, KYC pending</td>
          </tr>
          <tr style="background: #f5f5f5;">
            <td style="padding: 0; font-weight: bold;">🚁 Drone Dispatch</td>
            <td style="padding: 0; color: #1565C0; font-weight: bold;">CODED</td>
            <td style="padding: 0;">Dryad Silvaguard API integrated</td>
          </tr>
          <tr>
            <td style="padding: 0; font-weight: bold;">🌐 REST API + WebSocket</td>
            <td style="padding: 0; color: #2e7d32; font-weight: bold;">LIVE</td>
            <td style="padding: 0;">Full FastAPI backend running</td>
          </tr>
        </table>
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 25px;">
          ...
          <div style="flex: 1; background: #ffebee; padding: 0;
          ...
          <div style="flex: 1; background: #e8f5e9; padding: 0;
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
          <tr style="background: #B71C1C; color: white;">
            <th style="padding: 0; text-align: left;">Region</th>
            <th style="padding: 0; text-align: left;">Status</th>
            <th style="padding: 0; text-align: left;">Population at Risk</th>
          </tr>
          <tr style="background: #ffebee;">
            <td style="padding: 0;">Ontario–Michigan Border</td>
            <td style="padding: 0; color: #B71C1C; font-weight: bold;">🔴 ACTIVE EMERGENCY</td>
            <td style="padding: 0;">10 million</td>
          </tr>
          <tr>
            <td style="padding: 0;">Northern Ontario Boreal</td>
            <td style="padding: 0; color: #B71C1C; font-weight: bold;">🔴 ACTIVE EMERGENCY</td>
            <td style="padding: 0;">50 million downwind</td>
          </tr>
          <tr style="background: #ffebee;">
            <td style="padding: 0;">Alberta / BC Interior</td>
            <td style="padding: 0; color: #B71C1C; font-weight: bold;">🔴 728 detections today</td>
            <td style="padding: 0;">30 million downwind</td>
          </tr>
          <tr>
            <td style="padding: 0;">Upper Peninsula, Michigan</td>
            <td style="padding: 0; color: #B71C1C; font-weight: bold;">🔴 Ash fall confirmed</td>
            <td style="padding: 0;">4 million</td>
          </tr>
          <tr style="background: #ffebee;">
            <td style="padding: 0;">Saskatchewan Boreal</td>
            <td style="padding: 0; color: #B71C1C; font-weight: bold;">🔴 HIGH RISK</td>
            <td style="padding: 0;">20 million downwind</td>
          </tr>
        </table>
        ...
        <div style="text-align: center; margin: 0;">
          <a href="https://github.com/jRomBalance/wildfire-response-system"
             style="background: #B71C1C; color: white; padding: 0;
                    text-decoration: none; border-radius: 6px; font-weight: bold;
                    font-size: 16px; display: inline-block; margin: 0;">
            🔥 View the Code
          </a>
          <a href="https://firms.modaps.eosdis.nasa.gov/map/"
             style="background: #333; color: white; padding: 0;
                    text-decoration: none; border-radius: 6px; font-weight: bold;
                    font-size: 16px; display: inline-block; margin: 0;">
